...
describe('página Envie um encarte', () => {
  it('explica Instagram e tem campos obrigatórios + submit via jboSend', () => {
    ...
    expect(page).toContain('Nome da loja')
    ...
    expect(page).toContain('Instagram da loja')
    expect(page).toContain('Atualmente buscamos informações de encartes no Instagram da loja')
  })
})
